...
@interface HLCycleScrollView () <UICollectionViewDataSource, UICollectionViewDelegate>
...
- (void)initialization
{
    _pageControlAliment = HLCycleScrollViewPageContolAlimentCenter;
    ...
    _pageControlStyle = HLCycleScrollViewPageContolStyleClassic;
...
{
    HLCycleScrollView *cycleScrollView = [[self alloc] initWithFrame:frame];
...
- (void)setPageControlDotSize:(CGSize)pageControlDotSize
{
    ...
    if ([self.pageControl isKindOfClass:[HLPageControl class]]) {
        HLPageControl *pageContol = (HLPageControl *)_pageControl;
...
- (void)setCurrentPageDotColor:(UIColor *)currentPageDotColor
{
    ...
    if ([self.pageControl isKindOfClass:[HLPageControl class]]) {
        HLPageControl *pageControl = (HLPageControl *)_pageControl;
...
- (void)setCurrentPageDotImage:(UIImage *)currentPageDotImage
{
    ...
    if (self.pageControlStyle != HLCycleScrollViewPageContolStyleAnimated) {
        self.pageControlStyle = HLCycleScrollViewPageContolStyleAnimated;
    }
...
- (void)setPageControlStyle:(HLCycleScrollViewPageContolStyle)pageControlStyle
{
...
- (void)setupPageControl
{
    ...
    switch (self.pageControlStyle) {
        case HLCycleScrollViewPageContolStyleAnimated:
        {
            HLPageControl *pageControl = [[HLPageControl alloc] init];
        ...
        case HLCycleScrollViewPageContolStyleClassic:
        {
...
- (void)layoutSubviews
{
    ...
    if (self.pageControlAliment == HLCycleScrollViewPageContolAlimentRight) {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_titlesGroup.count && itemIndex < _titlesGroup.count) {
        if ([_titlesGroup[itemIndex] isKindOfClass:NSClassFromString(@"NSString")]) {
            cell.title = _titlesGroup[itemIndex];
        }else{
            
            cell.titleAttributedString = _titlesGroup[itemIndex];
        }
